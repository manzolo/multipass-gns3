...
case $VM_STATUS in
    ...
    "Stopped")
        ...
        removehost
        addhost
        multipass mount "$HOST_DIR_NAME/volume" "$VM_NAME:/home/${USERNAME}/GNS3" > /dev/null
        multipass mount "$HOST_DIR_NAME/config" "$VM_NAME:/home/${USERNAME}/.config/GNS3" > /dev/null
        ;;
    *) 
